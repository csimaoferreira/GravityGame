...
THREEx.Planets.createSun	= function(){
	...
	var texture	= THREE.TextureLoader(THREEx.Planets.baseURL+'images/sunmap.jpg')
...
THREEx.Planets.createMercury	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var material	= new THREE.MeshPhongMaterial({
		map	: THREE.TextureLoader(THREEx.Planets.baseURL+'images/mercurymap.jpg'),
		bumpMap	: THREE.TextureLoader(THREEx.Planets.baseURL+'images/mercurybump.jpg'),
		bumpScale: 0.005,
	})
...
THREEx.Planets.createVenus	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var material	= new THREE.MeshPhongMaterial({
		map	: THREE.TextureLoader(THREEx.Planets.baseURL+'images/venusmap.jpg'),
		bumpMap	: THREE.TextureLoader(THREEx.Planets.baseURL+'images/venusbump.jpg'),
		bumpScale: 0.005,
	})
	var mesh	= new THREE.Mesh(geometry, material)
	return mesh
...
THREEx.Planets.createEarth	= function(bumpScaleValue){
	// console.log(THREE.ImageUtils.loadTexture(THREEx.Planets.baseURL+'images/earthmap1k.jpg'));
	if (bumpScaleValue ==[]) {
		bumpScaleValue=0.0;
	}
	// bumpScaleValue=0.7
  ...
  // var mat1 = new THREE.MeshPhysicalMaterial({color:0x008000, shading:THREE.FlatShading}); // define material
	var mesh	= new THREE.Mesh(geometry, material)
	return mesh
}
...
THREEx.Planets.createMoon	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var material	= new THREE.MeshPhongMaterial({
		map	: THREE.TextureLoader(THREEx.Planets.baseURL+'images/moonmap1k.jpg'),
		bumpMap	: THREE.TextureLoader(THREEx.Planets.baseURL+'images/moonbump1k.jpg'),
		bumpScale: 0.002,
	})
	var mesh	= new THREE.Mesh(geometry, material)
	return mesh
...
THREEx.Planets.createMars	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var material	= new THREE.MeshPhongMaterial({
		map	: THREE.TextureLoader(THREEx.Planets.baseURL+'images/marsmap1k.jpg'),
		bumpMap	: THREE.TextureLoader(THREEx.Planets.baseURL+'images/marsbump1k.jpg'),
		bumpScale: 0.05,
	})
	var mesh	= new THREE.Mesh(geometry, material)
	return mesh
...
THREEx.Planets.createJupiter	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var texture	= THREE.TextureLoader(THREEx.Planets.baseURL+'images/jupitermap.jpg')
	var material	= new THREE.MeshPhongMaterial({
		map	: texture,
		bumpMap	: texture,
		bumpScale: 0.02,
...
THREEx.Planets.createSaturn	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var texture	= THREE.TextureLoader(THREEx.Planets.baseURL+'images/saturnmap.jpg')
	var material	= new THREE.MeshPhongMaterial({
		map	: texture,
		bumpMap	: texture,
		bumpScale: 0.05,
...
THREEx.Planets.createSaturnRing	= function(){
	...
	var material	= new THREE.MeshPhongMaterial({
		map		: new THREE.Texture(canvasResult),
		// map		: THREE.TextureLoader(THREEx.Planets.baseURL+'images/ash_uvgrid01.jpg'),
		side		: THREE.DoubleSide,
		transparent	: true,
		opacity		: 0.8,
	})
...
THREEx.Planets.createUranus	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var texture	= THREE.TextureLoader(THREEx.Planets.baseURL+'images/uranusmap.jpg')
	var material	= new THREE.MeshPhongMaterial({
		map	: texture,
		bumpMap	: texture,
		bumpScale: 0.05,
...
THREEx.Planets.createNeptune	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var texture	= THREE.TextureLoader(THREEx.Planets.baseURL+'images/neptunemap.jpg')
	var material	= new THREE.MeshPhongMaterial({
		map	: texture,
		bumpMap	: texture,
		bumpScale: 0.05,
...
THREEx.Planets.createPluto	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var material	= new THREE.MeshPhongMaterial({
		map	: THREE.TextureLoader(THREEx.Planets.baseURL+'images/plutomap1k.jpg'),
		bumpMap	: THREE.TextureLoader(THREEx.Planets.baseURL+'images/plutobump1k.jpg'),
		bumpScale: 0.005,
	})
	var mesh	= new THREE.Mesh(geometry, material)
	return mesh
...
THREEx.Planets.createStarfield	= function(){
	...
	var material	= new THREE.MeshPhongMaterial({
		map		: THREE.ImageUtils.loadTexture(THREEx.Planets.baseURL+'images/galaxy_starfield.png'),
		side	: THREE.BackSide
	})
	// material	= new THREE.MeshPhongMaterial({color:0x008000, shading:THREE.FlatShading})
